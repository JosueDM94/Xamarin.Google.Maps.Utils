...
*/
	...
	// @interface Testing (GMUDefaultClusterIconGenerator)
	[Category]
	[BaseType(typeof(GMUDefaultClusterIconGenerator))]
	interface GMUDefaultClusterIconGeneratorTesting
	{
		// -(UIImage *)iconForText:(NSString *)text withBaseImage:(UIImage *)image;
		[Export("iconForText:withBaseImage:")]
		UIImage IconForText(string text, UIImage image);

		// -(UIImage *)iconForText:(NSString *)text withBucketIndex:(NSUInteger)bucketIndex;
		[Export("iconForText:withBucketIndex:")]
		UIImage IconForText(string text, nuint bucketIndex);
	}
	...
	// @interface Testing (GMUDefaultClusterRenderer)
	[Category]
	[BaseType(typeof(GMUDefaultClusterRenderer))]
	interface GMUDefaultClusterRendererTesting
	{
...
*/
	...
	{
		// extern double GoogleMapsUtilitiesVersionNumber;
		[Field("GoogleMapsUtilitiesVersionNumber", "__Internal")]
		double GoogleMapsUtilitiesVersionNumber { get; }

		// extern const unsigned char [] GoogleMapsUtilitiesVersionString;
		[Field("GoogleMapsUtilitiesVersionString", "__Internal")]
		IntPtr GoogleMapsUtilitiesVersionString { get; }
	}
}