...
*/
	...
	// @interface GMUClusterManager : NSObject <MapViewDelegate>
	[BaseType(typeof(NSObject))]
	[DisableDefaultCtor]
	interface GMUClusterManager : IMapViewDelegate
	{
		// -(instancetype _Nonnull)initWithMap:(MapView * _Nonnull)mapView algorithm:(id<GMUClusterAlgorithm> _Nonnull)algorithm renderer:(id<GMUClusterRenderer> _Nonnull)renderer __attribute__((objc_designated_initializer));
		...
		// @property (readonly, nonatomic, weak) id<MapViewDelegate> _Nullable mapDelegate;
		[NullAllowed, Export("mapDelegate", ArgumentSemantic.Weak)]
		NSObject WeakMapDelegate { get; }

		// -(void)setDelegate:(id<GMUClusterManagerDelegate> _Nullable)delegate mapDelegate:(id<MapViewDelegate> _Nullable)mapDelegate;
	...
	{
		// @optional -(Marker * _Nullable)renderer:(id<GMUClusterRenderer> _Nonnull)renderer markerForObject:(id _Nonnull)object;
		[Export("renderer:markerForObject:")]
		[return: NullAllowed]
		Marker MarkerForObject(IGMUClusterRenderer renderer, NSObject @object);

		// @optional -(void)renderer:(id<GMUClusterRenderer> _Nonnull)renderer willRenderMarker:(Marker * _Nonnull)marker;
		[Export("renderer:willRenderMarker:")]
		void WillRenderMarker(IGMUClusterRenderer renderer, Marker marker);

		// @optional -(void)renderer:(id<GMUClusterRenderer> _Nonnull)renderer didRenderMarker:(Marker * _Nonnull)marker;
	...
	interface GMUDefaultClusterRenderer : GMUClusterRenderer
	{
		...
		// -(instancetype _Nonnull)initWithMapView:(MapView * _Nonnull)mapView clusterIconGenerator:(id<GMUClusterIconGenerator> _Nonnull)iconGenerator;
...
*/
	...
	interface GMUFeature : GMUGeometryContainer
	{
		...
		// @property (readonly, nonatomic) CoordinateBounds * _Nullable boundingBox;
		[NullAllowed, Export("boundingBox")]
		CoordinateBounds BoundingBox { get; }

		// -(instancetype _Nonnull)initWithGeometry:(id<GMUGeometry> _Nonnull)geometry identifier:(NSString * _Nullable)identifier properties:(NSDictionary<NSString *,NSString *> * _Nullable)properties boundingBox:(CoordinateBounds * _Nullable)boundingBox;
	...
	{
		// -(instancetype _Nonnull)initWithMap:(MapView * _Nonnull)map geometries:(NSArray<id<GMUGeometryContainer>> * _Nonnull)geometries;
		[Export("initWithMap:geometries:")]
		IntPtr Constructor(MapView map, IGMUGeometryContainer[] geometries);

		// -(instancetype _Nonnull)initWithMap:(MapView * _Nonnull)map geometries:(NSArray<id<GMUGeometryContainer>> * _Nonnull)geometries styles:(NSArray<GMUStyle *> * _Nullable)styles;
...
*/
	...
	// @interface GMUHeatmapTileLayer : SyncTileLayer
	...
	{
		// @property (readonly, nonatomic) Path * _Nonnull path;
		[Export("path")]
		Path Path { get; }

		// -(instancetype _Nonnull)initWithPath:(Path * _Nonnull)path;
		[Export("initWithPath:")]
	...
	{
		// @property (readonly, nonatomic) NSArray<Path *> * _Nonnull paths;
		[Export("paths")]
		Path[] Paths { get; }

		// -(instancetype _Nonnull)initWithPaths:(NSArray<Path *> * _Nonnull)paths;
